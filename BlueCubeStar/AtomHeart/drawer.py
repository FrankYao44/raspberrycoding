...
class Brush(object):
    def __init__(self, screen):
        ...
        self.brush = pygame.image.load(os.path.join(os.path.abspath('.'), 'resource', "brush.png")).convert_alpha()
...
class Menu():
    def __init__(self, screen):
        ...
        self.pens = [
            pygame.image.load(os.path.join(os.path.abspath('.'), 'resource', "pen1.png")).convert_alpha(),
            pygame.image.load(os.path.join(os.path.abspath('.'), 'resource', "pen2.png")).convert_alpha()
        ]
        self.pens_rect = []
        ...
        self.sizes = [
            pygame.image.load(os.path.join(os.path.abspath('.'), 'resource', "big.png")).convert_alpha(),
            pygame.image.load(os.path.join(os.path.abspath('.'), 'resource', "small.png")).convert_alpha()
        ]
        self.sizes_rect = []
